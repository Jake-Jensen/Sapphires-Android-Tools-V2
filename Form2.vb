Public Class Form2
    ...
    Private Sub ButtonsButton_Click(sender As Object, e As EventArgs) Handles ButtonsButton.Click
        ReadmeLabel.Text = "There are numerous buttons in the application, and are generally self explained. 'Logcat' will logcat your phone, pulling the most recent logs, and saving them. 'Root Shell' will attempt root via various methods, which range from a simple 'su' to a full exploit injection. 'SEPolicy' will attempt to set SELinux to permissive. Be aware, you require root for this." & vbNewLine & "DCV1 is capable of rooting almost any Lollipop phone/tablet, if they are using 32bit CPUs. Will automatically run in compatibility mode for the Z981 if it's detected."
    End Sub
